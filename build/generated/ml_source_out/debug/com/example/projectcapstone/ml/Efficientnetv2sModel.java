package com.example.projectcapstone.ml;
...
public final class Efficientnetv2sModel {
  @NonNull
  ...
  private Efficientnetv2sModel(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "efficientnetv2s_model.tflite", options);
    ...
    ImageProcessor.Builder imageProcessorBuilder = new ImageProcessor.Builder()
      .add(new ResizeOp(384, 384, ResizeMethod.NEAREST_NEIGHBOR))
  ...
  @NonNull
  public static Efficientnetv2sModel newInstance(@NonNull Context context) throws IOException {
    return new Efficientnetv2sModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Efficientnetv2sModel newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new Efficientnetv2sModel(context, options);
  }
